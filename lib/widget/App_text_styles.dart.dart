...
class AppColors {
  //  للبلكيشن الألوان الأساسية
  static const Color primary = Color(0xFF004A63);
  static const Color secondary = Color(0xFF006C8D);

  // ألوان الخلفيات
  static const Color lightBackground = Color(0xFFEAF9FC);
